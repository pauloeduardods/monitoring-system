...
import (
	...
	"monitoring-system/api/gin_server/handlers"
	"monitoring-system/api/gin_server/middleware"
	"monitoring-system/api/gin_server/routes"
	"monitoring-system/api/websocket"
